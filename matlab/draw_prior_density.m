...
switch pshape(indx)
  ...
  case 8 %Weibull
    infbound = wblinv(truncprior,p6(indx),p7(indx))+p3(indx);
    supbound = wblinv(1-truncprior,p6(indx),p7(indx))+p3(indx);
    abscissa = linspace(infbound,supbound,steps);
    dens     =  exp(lpdfweibull(abscissa-p3(indx),p6(indx),p7(indx)));
  otherwise
