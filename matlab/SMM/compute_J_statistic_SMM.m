function J_test=compute_J_statistic_SMM(xparam1,DynareDataset,DynareOptions,Model,EstimatedParameters,SMMinfo,DynareResults)
% Computes the J-statistic after SMM estimation 
...
J_test.j_stat=DynareDataset.info.ntobs*DynareResults.smm.variance_correction_factor*fval;
